<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-row justify-between items-center">
            ...
            <a href="{{route('admin.testimonials.create')}}" class="font-bold py-4 px-6 bg-white text-gray-800 rounded-full">
                Add New
            </a>
        </div>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                    ...
                    <div class="flex flex-row items-center gap-x-3">
                        ...
                        <div class="flex flex-col">
                            <h3 class="text-indigo-950 text-xl font-bold">
                                {{$testimonial->client->name ?? 'Client data is deleted'}}
                            </h3>
                        </div>
                    </div> 
                ...
                <div class="flex flex-col items-center justify-center">
                    <h3 class="text-xl font-bold text-slate-500">No Data Found</h3>
                </div>
                @endforelse
            </div>
        </div>
