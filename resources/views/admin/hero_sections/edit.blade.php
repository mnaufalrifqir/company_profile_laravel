                ...
                <form method="POST" action="{{route('admin.hero_sections.update', $hero_section)}}" enctype="multipart/form-data">
                    ...
                    <div>
                        ...
                        <x-text-input id="heading" class="block mt-1 w-full" type="text" name="heading" value="{{$hero_section->heading}}"
                          required autofocus autocomplete="heading" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="subheading" class="block mt-1 w-full" type="text" name="subheading" value="{{$hero_section->subheading}}"
                        required autofocus autocomplete="subheading" />
                        <x-input-error :messages="$errors->get('subheading')" class="mt-2" />
                    </div>

                    <div class="mt-4">
                        <x-input-label for="achievement" :value="__('achievement')" />
                        <x-text-input id="achievement" class="block mt-1 w-full" type="text" name="achievement" value="{{$hero_section->achievement}}"
                        required autofocus autocomplete="achievement" />
                        <x-input-error :messages="$errors->get('achievement')" class="mt-2" />
                    </div>

                    <div class="mt-4">
                        <x-input-label for="path_video" :value="__('path_video')" />
                        <x-text-input id="path_video" class="block mt-1 w-full" type="text" name="path_video" value="{{$hero_section->path_video}}"
                        required autofocus autocomplete="path_video" />
